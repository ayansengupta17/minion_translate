...
def on_input_text_eng_change():
    ...
    doc.set(data)
    st.session_state.minionize_count = count_eng2min_doc.get().get("num")
    count_eng2min_doc.set({"num": st.session_state.minionize_count + 1, "updated": datetime.datetime.now()})
...
def on_input_text_min_change():
    ...
    doc.set(data)
    st.session_state.humanize_count = count_min2eng_doc.get().get("num")
    count_eng2min_doc.set({"num": st.session_state.humanize_count + 1, "updated": datetime.datetime.now()})
